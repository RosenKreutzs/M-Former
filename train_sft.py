...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_len", type=int, default=500)
    parser.add_argument('--dropout', type=float, default=0.1, help='dropout')
    parser.add_argument('--load_ts_encoder', type=str, default='save/pretrain/model.safetensors',
                        help='load ts_encoder')

    # MFormer setting
    parser.add_argument('--m_d_model', type=int, default=896, help='dimension of M model')
    parser.add_argument('--m_n_heads', type=int, default=16, help='num of M heads')
    parser.add_argument('--m_layers', type=int, default=2, help='num of M layers')
    parser.add_argument('--m_dropout', type=float, default=0.1, help='dropout for M model')
    ...
    parser.add_argument('--eval_stragy', type=str, default="no",
    ...
    ts_past_train = 'dataset/datasets/train_data_cleaned.h5'
    qa_past_train = 'dataset/datasets/train_qa_cleaned.jsonl'

    ts_path_test = 'dataset/datasets/test_data_cleaned.h5'
    qa_path_test = 'dataset/datasets/test_qa_cleaned.jsonl'
    ...
    Trainer = Exp_Instruct(args, train_dataset=train_dataset, eval_dataset=test_dataset,
                           tlm_config=tlmconfig)  # Trainer.train(resume_from_checkpoint=False)
